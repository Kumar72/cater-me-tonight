...
START TRANSACTION;
USE `catermetonight`;
INSERT INTO `menu_item` (`id`, `name`, `description`, `price`, `picture_url`, `kitchen_id`, `course_id`) VALUES (1, 'Soup du Jour', DEFAULT, 7, 'http://www.wildfowlmag.com/files/2015/03/duck_soup_du_jour_f.jpg', 1, 1);
INSERT INTO `menu_item` (`id`, `name`, `description`, `price`, `picture_url`, `kitchen_id`, `course_id`) VALUES (2, 'Grand Marnier Beignets', DEFAULT, 5, 'http://www.zencancook.com/wp-content/uploads/2009/12/quince-beignet-8.jpg', 1, 1);
